...
export const books: Book[] = [
  ...
  {
    slug: "approved-mortgage-playbook",
    title: "APPROVED",
    subtitle: "The Mortgage Playbook Your Bank May Never Show You",
    positioning:
      "For buyers who were told no, or expect to be. 48 real questions about FHA loans, down payment help, co-signers, and the programs your bank may never mention.",
    shortDescription:
    ...
    editions: [
      {
        format: "Paperback",
        schemaFormat: "https://schema.org/Paperback",
        url: "https://www.amazon.com/dp/B0HJLLJHR7",
        available: true,
        isbn: "9798173583147",
        asin: "B0HJLLJHR7",
      },
      {
        format: "Hardcover",
        schemaFormat: "https://schema.org/Hardcover",
        url: "https://www.amazon.com/dp/B0HJLJGGHK",
        available: true,
        isbn: "9798173583840",
        asin: "B0HJLJGGHK",
      },
      {
        format: "Kindle eBook",
        schemaFormat: "https://schema.org/EBook",
        url: "https://www.amazon.com/dp/B0HJLMGJZY",
        available: true,
        asin: "B0HJLMGJZY",
      },
    ],
    retailers: [
      ...
      },
      {
        ...
        url: "",
        group: "buy",
        // Ebook goes wide via Draft2Digital next. Flip on per retailer as it lists.
        available: false,
      },
      {
        slug: "barnes-noble",
