...
export function PageCTA({
  ...
  return (
    <section className="relative overflow-hidden bg-brand-green py-16 sm:py-20 lg:py-24">
      ...
      <div className="relative mx-auto max-w-[1400px] px-5 sm:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <div className="mt-8">
            <Link
              href={ctaHref}
              className="group relative inline-flex items-center gap-2.5 rounded-full bg-white px-9 py-4 text-[16px] font-bold text-brand-green shadow-[0_4px_24px_rgba(0,0,0,0.15)] transition-all duration-300 hover:bg-white/90 hover:shadow-[0_8px_40px_rgba(0,0,0,0.2)]"
            >
              <span>{ctaText}</span>
              <svg
