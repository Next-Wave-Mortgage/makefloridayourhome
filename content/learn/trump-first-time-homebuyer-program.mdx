...
Tax credits do not replace down payment assistance and do not reduce cash-to-close unless paired with [state or local programs](/learn/first-time-homebuyer/grants-and-programs).
