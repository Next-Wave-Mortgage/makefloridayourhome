...
- **Mark:** Circular brand green badge with a white palm tree silhouette
- **Wordmark:** "MAKE FLORIDA YOUR HOME" (small caps, green) above "NEXT WAVE" (bold, charcoal) with "MORTGAGE" below in smaller weight
...
| **Charcoal**    | `#333333` | `51, 51, 51`    | Headings, nav links, primary body text, footer background |
...
| ------------ | ---- | ------ | ------------------ | ---------------------------------------------------------------------- |
| **H1**       | 42px | 700    | Charcoal `#333333` | Page hero headings                                                     |
| **H2**       | 36px | 700    | Charcoal `#333333` | Section headings. First keyword often set in Brand Green for emphasis. |
| **H3**       | 22px | 700    | Charcoal `#333333` | Card titles, sub-section headings                                      |
| **Body**     | 16px | 400    | Charcoal `#333333` | Paragraph text                                                         |
| **Nav Link** | 15px | 700    | Charcoal `#333333` | Top navigation items                                                   |
| **Small**    | 14px | 400    | Mid Gray `#ABACAC` | Captions, disclaimers                                                  |

### Heading Accent Pattern

Section headings use a **split-color** technique: the first keyword is rendered in **Brand Green (`#006948`)** while the rest stays in **Charcoal (`#333333`)**. Examples:
...
- Full-width CTA banner bars use **Charcoal (`#333333`)** or **Brand Green (`#006948`)** background with white text
...
- Team/expert photos framed with a **Brand Green (`#006948`) border accent** on one corner (typically top-left or bottom-left)
...
- Two-column layout
- Charcoal chevron toggle icon
- Bold question text, expandable answer

### CTA Banners

- Full-width CTA strip (`#333333` or `#006948`)
