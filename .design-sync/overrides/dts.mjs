// forked from design-sync lib/dts.mjs — FAQ is a real React component in this
// repo; the ALL-CAPS constant heuristic in isComponentName excluded it.
//
...
export const isComponentName = (n) => n === 'FAQ'
  || (!n.endsWith('Props') && !/^[A-Z][A-Z0-9_]+$/.test(n)
