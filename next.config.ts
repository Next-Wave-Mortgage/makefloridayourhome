...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      "default-src 'self'",
      `script-src 'self' 'unsafe-inline'${process.env.NODE_ENV === "development" ? " 'unsafe-eval'" : ""} https://www.googletagmanager.com https://www.google-analytics.com https://static.hsappstatic.net https://lead-form.nextwavemortgage.com https://booking.nextwavemortgage.com`,
      ...
      "frame-src https://meetings.hubspot.com",
